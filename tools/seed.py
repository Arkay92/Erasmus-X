...
class SeedingEngine:
    def __init__(self, questions_file):
        ...
        """
        self.brain = HypervectorDB(filename=config.BRAIN_STORAGE_PATH)
        self.kg = KnowledgeGraph(storage=self.brain)
        self.searcher = WebSearcher()
        self.client = create_model_client("main")
...
if __name__ == "__main__":
    ...
    curriculum_path = str(PROJECT_ROOT / "shards" / "questions" / "world_curriculum.md")
